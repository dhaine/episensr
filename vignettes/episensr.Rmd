...
output: 
  rmarkdown::html_vignette:
    fig_caption: yes
vignette: >
  %\VignetteIndexEntry{01-Quantitative Bias Analysis for Epidemiologic Data}
...
(_Note: A Shiny app is available for some functions, at
<https://dhaine.shinyapps.io/apisensr/>._, using the R package `apisensr` which
is based on `episensr`.)
...
al.](http://onlinelibrary.wiley.com/doi/10.1002/sim.4780070704/full#abstract) and [Chu et
