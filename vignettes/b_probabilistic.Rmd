...
## Record-level bias analysis
Create record level data from smoking case control study.
```{r}
a <- 215
b <- 1449
c <- 668
...
set.seed(1234)
model <- probcase(D, x = e_obs, y = d, reps = 10^2, type = "exposure",
